...
// in simulator we redefine to format for NewStyleCfe Developer console
...
{\
	NSString * exceptionName = [@"org.newstylecfe." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.newstylecfe";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UINewStyleCfeNativeItemNone = -1, 
	UINewStyleCfeNativeItemSpinner = -2,
	UINewStyleCfeNativeItemProgressBar = -3,
	
	UINewStyleCfeNativeItemSlider = -4,
	UINewStyleCfeNativeItemSwitch = -5,
	UINewStyleCfeNativeItemMultiButton = -6,
	UINewStyleCfeNativeItemSegmented = -7,
	
	UINewStyleCfeNativeItemTextView = -8,
	UINewStyleCfeNativeItemTextField = -9,
	UINewStyleCfeNativeItemSearchBar = -10,
	
	UINewStyleCfeNativeItemPicker = -11,
	UINewStyleCfeNativeItemDatePicker = -12,
	
	UINewStyleCfeNativeItemInfoLight = -13,
	UINewStyleCfeNativeItemInfoDark = -14,
	
	UINewStyleCfeNativeItemDisclosure = -15,
	
	UINewStyleCfeNativeItemContactAdd = -16
};
