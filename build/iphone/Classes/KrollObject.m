...
//@interface NewStyleCfeObject : NSObject
//@end

@interface NewStyleCfeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NewStyleCfeObject class]])
		{
			for (NSString *key in [[(NewStyleCfeObject*)o modules] allKeys])
			{
